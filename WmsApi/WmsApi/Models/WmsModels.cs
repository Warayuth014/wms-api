...
// เพิ่มใน Models/WmsModels.cs

// =============================================
// master.Customers
// =============================================
[Table("Customers", Schema = "master")]
...
// flow1.SalesOrders
// =============================================
[Table("SalesOrders", Schema = "flow1")]
public class SalesOrder
{
    ...
    public string CustomerId { get; set; } = string.Empty;
    public string Status { get; set; } = "PENDING";
    // PENDING | SHIPPED | RETURNED | PARTIAL_RETURN
    public string CreatedBy { get; set; } = string.Empty;
    public DateTime CreatedAt { get; set; } = DateTime.UtcNow;
    public DateTime UpdatedAt { get; set; } = DateTime.UtcNow;
...
// =============================================
// flow1.SalesOrderItems
// =============================================
[Table("SalesOrderItems", Schema = "flow1")]
...
// flow1.ReturnOrders
// =============================================
[Table("ReturnOrders", Schema = "flow1")]
...
// flow1.ReturnLines
// =============================================
[Table("ReturnLines", Schema = "flow1")]
