...
namespace WmsApi.Migrations
{
    ...
    [Migration("20260403043050_DropReturnAndSalesOrderTables")]
    partial class DropReturnAndSalesOrderTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WmsApi.Models.ReplenishOrder", b =>
                {
                    ...
                    b.ToTable("ReplenishOrders", "flow2");
                });

            modelBuilder.Entity("WmsApi.Models.ReplenishOrderLine", b =>
                {
                    b.Property<int>("LineId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ReplenishOrderLines", "flow2");
                });

            modelBuilder.Entity("WmsApi.Models.ReplenishSession", b =>
                {
                    b.Property<int>("SessionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ReplenishSessions", "flow2");
                });

            modelBuilder.Entity("WmsApi.Models.ReplenishSessionLine", b =>
                {
                    b.Property<int>("LineId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ReplenishSessionLines", "flow2");
                });
            ...
            modelBuilder.Entity("WmsApi.Models.Tote", b =>
                {
                    b.Property<string>("ToteId")
                        .HasColumnType("nvarchar(50)");
                    ...
                    b.ToTable("Totes", "master");
                });

            modelBuilder.Entity("WmsApi.Models.ToteInventory", b =>
                {
                    ...
                    b.HasIndex("ToteId", "PartId")
                        .IsUnique();

                    b.ToTable("ToteInventory", "master");
                });
            ...
            modelBuilder.Entity("WmsApi.Models.ReplenishOrderLine", b =>
                {
                    b.HasOne("WmsApi.Models.ReplenishOrder", "ReplenishOrder")
                        .WithMany("Lines")
            ...
            modelBuilder.Entity("WmsApi.Models.ReplenishSession", b =>
                {
                    ...
                    b.HasOne("WmsApi.Models.Tote", "Tote")
                        .WithMany("ReplenishSessions")
            ...
            modelBuilder.Entity("WmsApi.Models.ReplenishSessionLine", b =>
                {
                    b.HasOne("WmsApi.Models.ReplenishOrderLine", "OrderLine")
                        .WithMany("SessionLines")
                    ...
                    b.HasOne("WmsApi.Models.ReplenishSession", "Session")
                        .WithMany("Lines")
                        .HasForeignKey("SessionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("WmsApi.Models.Tote", b =>
                {
                    ...
                    b.Navigation("ReplenishSessions");
                });
